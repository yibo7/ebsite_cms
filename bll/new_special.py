...
from eb_utils.configs import SiteConstant, WebPaths
...
class NewsSpecial(BllBase[NewsSpecialModel]):
    ...
    def get_tree(self):
        ...
        for tree in datas:
            if not tree.parent_id:
                tree.name = f"<img src='{WebPaths.ADMIN_PATH}images/tree/w1.gif' align=absmiddle><b><font color=green>{tree.name}</font></b>"
                get_tree.append(tree)
