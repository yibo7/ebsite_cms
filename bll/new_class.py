...
class NewsClass(BllBase[NewsClassModel]):
    ...
    def save_class(self, model: NewsClassModel):
        ...
        results = class_saving.send(model)  # 保存前触发事件
    ...
    def get_tree(self):
        ...
        for tree in datas:
            if not tree.parent_id:
                tree.class_name = f"<img src='{WebPaths.ADMIN_PATH}images/tree/w1.gif' align=absmiddle><b><font color=green>{tree.class_name}</font></b>"
                get_tree.append(tree)
    ...
    def get_sub_item(self, data_id, new_class, blank, old_class):
        ...
        sW3 = f'<img src=\"{WebPaths.ADMIN_PATH}images/tree/w3.gif\" align=absmiddle>'
        sW1 = f'<img src=\"{WebPaths.ADMIN_PATH}images/tree/w1.gif\" align=absmiddle>'
    ...
    def move_to(self, from_id, target_id, move_type: int):
        ...
        self.db[self.table_name].update_many(
            {
